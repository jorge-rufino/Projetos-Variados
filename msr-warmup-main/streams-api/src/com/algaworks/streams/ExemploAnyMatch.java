...
//		}
		...
		boolean temPicanha = produtos.stream()
			.anyMatch(p -> p.getNome().equals("Picanha 1kg"));	//Se encontrar algum elemento que satisfaça o "predicate", ele retorna "true"

		System.out.println(temPicanha);
		
				temPicanha = produtos.stream()
				.anyMatch(p -> p.getNome().equals("Picanha 2kg"));	//Se encontrar algum elemento que satisfaça o "predicate", ele retorna "true"
