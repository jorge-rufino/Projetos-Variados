...
public class PersonOverviewController {
    ...
    //Criei este método somente para sumir o alerta de que o "mainApp" nao estava sendo usado
...
//    Chamado quando o usuário clica no botão delete.
    ...
    private void handleDeletePerson() {
        ...
        if (selectedIndex >= 0) {
            ...
            // Nada selecionado.          
        	Alerts.showAlert("Nenhuma seleção", "Nenhuma Pessoa selecionada", "Por favor, seletciona uma pessoa", AlertType.WARNING);
        }
    }
